<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormConvTijuca.aspx.cs" Inherits="Consultorio.FormConvTijuca" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
      <link rel="stylesheet" type="text/css" href="Pagina7.css" />
    <title></title>
</head>
<body>
      <header id="cinquenta"><img  alt="" src="Imagem/01.jpg" /></header>
...
&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="VERIFICAR" OnClick="Button1_Click" Width="103px" />
            &nbsp;<asp:DropDownList ID="DropDownList3" runat="server" Width="92px">
            </asp:DropDownList>
...
&nbsp;<asp:TextBox ID="TextBox10" runat="server" placeholder="SOMENTE NUMEROS" Width="629px" OnTextChanged="TextBox10_TextChanged"></asp:TextBox>
            <br />
            <br />
...
&nbsp;&nbsp;<asp:DropDownList ID="DropDownList2" runat="server" style="margin-left: 0px; margin-bottom: 0px">
            ...
            &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="CONFERIR DATA" />
...
&nbsp;<asp:TextBox ID="TextBox9" runat="server" placeholder="xxxx@xxxx.com" Width="286px" OnTextChanged="TextBox9_TextChanged"></asp:TextBox>
            <br />
            <br />
            <br />
&nbsp;&nbsp;
...
&nbsp;
     ...
     <footer id="cinquenta1"><img alt="" src="Imagem/01.jpg" /></footer>
</body>
</html>
