...
{
    public partial class FormConvTijuca : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand acha = new SqlCommand("select distinct DtConsulta,Dia_Consulta from Paciente_Clinica_Tijuca where DtConsulta='" + DropDownList1.Text + "'", conecta1);
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox2.Text == "")
            {
                ...
                Response.Redirect("http://localhost:50054/FormConvTijuca.aspx");
                Response.Write("<script>alert('O CAMPO NUMERO CARTEIRA  NAO FOI PREENCHIDO')</script>");
            }
            ...
            SqlCommand novo = new SqlCommand("Insert into Paciente_Clinica_Tijuca values('" + carteira + "','" + cpf + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + DropDownList5.Text + "','" + DropDownList6.Text + "','" + DropDownList2.Text + "','" + TextBox9.Text + "')", SqlConn);
